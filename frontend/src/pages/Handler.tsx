    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok && data.success) {
                navigate(`/lesson/${selectedCourse}/${classId}`); // Переходим на главную страницу
            } else {
            ...
            <div style={formContainerStyle}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <select 
                        ...
                        style={inputStyle}
                    >
                         {classes.map(class_object => (
                            <option key={class_object.id} value={class_object.id}>
                                {class_object.number} класс
                            </option>
                        ))}
                    </select>
